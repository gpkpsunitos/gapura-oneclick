...
export const TABLES: TableDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'role', label: 'Role', type: 'string', enumValues: ['SUPER_ADMIN', 'DIVISI_OS', 'DIVISI_OT', 'DIVISI_OP', 'DIVISI_UQ', 'DIVISI_HC', 'DIVISI_HT', 'ANALYST', 'MANAGER_CABANG', 'STAFF_CABANG'] },
      { name: 'division', label: 'Divisi', type: 'string', enumValues: ['GENERAL', 'OS', 'OT', 'OP', 'UQ', 'HC', 'HT'] },

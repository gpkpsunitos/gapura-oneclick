...
/**
 * Mengirim notifikasi ke pelapor saat laporan ditutup.
 * Deduplikasi memakai fingerprint report + recipient agar status CLOSED berulang tidak mengirim email ganda.
 */

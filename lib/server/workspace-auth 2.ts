...
export const LOOKERS_ALLOWED_ROLES = ['SUPER_ADMIN', 'ANALYST', 'DIVISI_ESKALASI', 'DIVISI_OS', 'DIVISI_OT', 'DIVISI_OP', 'DIVISI_UQ', 'DIVISI_HC', 'DIVISI_HT', 'PARTNER_OS', 'PARTNER_OT', 'PARTNER_OP', 'PARTNER_UQ', 'PARTNER_HC', 'PARTNER_HT'] as const;
...
export function canAccessLookers(role: string | null | undefined): boolean {
    return LOOKERS_ALLOWED_ROLES.includes(normalizeRole(role) as any);
}
